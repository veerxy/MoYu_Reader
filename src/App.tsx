...
export default function App() {
  ...
  return (
    ...
    <div
      ...
      className={`w-full h-full max-h-screen overflow-hidden flex flex-col font-sans select-none box-border transition-all duration-200 ease-out ${getContainerBgClass()} ${
