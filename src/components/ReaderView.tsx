    ...
    >
      ...
      {isToolbarVisible && (
        <header
          ...
          className="shrink-0 flex items-center justify-between px-4 py-2.5 z-30 transition-all border-b border-zinc-200/60 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md"
        >
      ...
      {!isToolbarVisible && (
        <div
          ...
          className="absolute top-0 left-0 right-0 h-6 group z-30 flex justify-center items-start pt-1 pointer-events-auto"
        >
          <button
            type="button"
            onClick={() => setIsToolbarVisible(true)}
            className="opacity-0 group-hover:opacity-100 focus:opacity-100 transition-all duration-200 -translate-y-2 group-hover:translate-y-0 px-3 py-1 rounded-full bg-zinc-900/85 text-white text-[11px] shadow-lg backdrop-blur-xs flex items-center gap-1.5 hover:bg-zinc-900"
          >
