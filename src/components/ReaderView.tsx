    ...
    >
      ...
      {isToolbarVisible && (
        <header
          ...
          className="shrink-0 h-10 flex items-center justify-between px-3 z-30 border-b border-zinc-200/80 dark:border-zinc-800 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md cursor-move select-none text-xs"
        >
